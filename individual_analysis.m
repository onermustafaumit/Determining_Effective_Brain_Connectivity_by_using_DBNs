...
disleksi_before = xlsread('individual_data.xls','disleksi_before','A1:CV10');
disleksi_after = xlsread('individual_data.xls','disleksi_after','A1:CV10');
kontrol_before = xlsread('individual_data.xls','kontrol_before','A1:CV10');
kontrol_after = xlsread('individual_data.xls','kontrol_after','A1:CV10');
...
foldername=strcat('DBNs_Shared_by_',num2str(coeff),'_10th_of_individuals_threshold_',threshold);
...
label=['DBN Connections Common in ' num2str(coeff) '/10 of Individuals of Control Before'];
drawDBNType3(type3_posterior_kb,0.2,label);
h1=gcf;
...
title('\mu±\sigma for Individual Control Before Data')
...
label=['DBN Connections Common in ' num2str(coeff) '/10 of Individuals of Control After'];
drawDBNType3(type3_posterior_ka,0.2,label);
h3=gcf;
...
title('\mu±\sigma for Individual Control After Data')
...
label=['DBN Connections Common in ' num2str(coeff) '/10 of Individuals of Dyslexia Before'];
drawDBNType3(type3_posterior_db,0.2,label);
h5=gcf;
...
title('\mu±\sigma for Individual Dyslexia Before Data')
...
label=['DBN Connections Common in ' num2str(coeff) '/10 of Individuals of Dyslexia After'];
drawDBNType3(type3_posterior_da,0.2,label);
h7=gcf;
...
title('\mu±\sigma for Individual Dyslexia After Data')
...
cd(dirname)
saveas(h1,'Common_DBN_for_Individual_Control_Before_Models.bmp','bmp');
saveas(h2,'Connection_Weights_for_Individual_Control_Before_Models.bmp','bmp');
saveas(h3,'Common_DBN_for_Individual_Control_After_Models.bmp','bmp');
saveas(h4,'Connection_Weights_for_Individual_Control_After_Models.bmp','bmp'); 
saveas(h5,'Common_DBN_for_Individual_Dyslexia_Before_Models.bmp','bmp');
saveas(h6,'Connection_Weights_for_Individual_Dyslexia_Before_Models.bmp','bmp');
saveas(h7,'Common_DBN_for_Individual_Dyslexia_After_Models.bmp','bmp');
saveas(h8,'Connection_Weights_for_Individual_Dyslexia_After_Models.bmp','bmp');
saveas(h9,'Connection_Weights_for_Individual_CB_and_CA_Models.bmp','bmp');
saveas(h10,'Connection_Weights_for_Individual_DB_and_DA_Models.bmp','bmp');
saveas(h11,'Connection_Weights_for_Individual_CB_and_DB_Models.bmp','bmp');
saveas(h12,'Connection_Weights_for_Individual_CA_and_DA_Models.bmp','bmp');
cd ..
